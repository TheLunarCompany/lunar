![Unit Tests](https://github.com/TheLunarCompany/lunar-java-interceptor/actions/workflows/unit-tests.yml/badge.svg)
![Black Formatter](https://github.com/TheLunarCompany/lunar-java-interceptor/actions/workflows/formatting.yml/badge.svg)
![Type Checker](https://github.com/TheLunarCompany/lunar-java-interceptor/actions/workflows/type-checking.yml/badge.svg)
![Build](https://github.com/TheLunarCompany/lunar-java-interceptor/actions/workflows/build-publish.yml/badge.svg)

- [Overview](#overview)
- [How it works?](#how-it-works)
  - [Failsafe Mechanism](#failsafe-mechanism)
- [Supported HTTP/S clients](#supported-https-clients)
...
# Supported HTTP/S clients

| Client                                      | Support |
| ------------------------------------------- | ------- |
| [okhttp3](https://github.com/square/okhttp) | JDK8+   |
...
_If both lists [`LUNAR_ALLOW_LIST` and `LUNAR_BLOCK_LIST`] exists, the Interceptor will display a warning saying that it can not continue with both types and will use only the `LUNAR_ALLOW_LIST` avoiding the `LUNAR_BLOCK_LIST` so only allowed domain will be used._
...
Then, if your Java application uses a supported client, the Interceptor will handle the requests.
