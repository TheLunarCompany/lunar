...
VITE_ADMIN_WEBSERVER_URL="${VITE_ADMIN_WEBSERVER_URL:-}"
VITE_ENABLE_PERMISSIONS="${VITE_ENABLE_PERMISSIONS:-false}"
VITE_ENABLE_DYNAMIC_CAPABILITIES="${VITE_ENABLE_DYNAMIC_CAPABILITIES:-false}"
VITE_ADD_SERVER_CHECKBOX="${VITE_ADD_SERVER_CHECKBOX:-}"
VITE_ENABLE_CAPABILITIES_UI="${VITE_ENABLE_CAPABILITIES_UI:-false}"
VITE_SHOW_SKILLS_PAGE="${VITE_SHOW_SKILLS_PAGE:-false}"
VITE_UI_SIDEBAR_RESTRUCTURE="${VITE_UI_SIDEBAR_RESTRUCTURE:-false}"
...
cat > "$CONFIG_FILE" << EOF
{
  ...
  "VITE_ENABLE_DYNAMIC_CAPABILITIES": "${VITE_ENABLE_DYNAMIC_CAPABILITIES}",
  "VITE_ADD_SERVER_CHECKBOX": "${VITE_ADD_SERVER_CHECKBOX}",
  "VITE_ENABLE_CAPABILITIES_UI": "${VITE_ENABLE_CAPABILITIES_UI}",
  "VITE_SHOW_SKILLS_PAGE": "${VITE_SHOW_SKILLS_PAGE}",
  "VITE_UI_SIDEBAR_RESTRUCTURE": "${VITE_UI_SIDEBAR_RESTRUCTURE}"
}
EOF
