...
const mockSystemState: SystemState = {
  ...
  connectedClients: [
    ...
    {
      sessionId: "offline-0001",
      clientId: "c-offline",
      usage: { callCount: 0 },
      consumerTag: "team-offline",
      clientInfo: {
        name: "vscode",
        version: "0.9.0",
        protocolVersion: "2025-11-25",
      ...
      disconnectedAt: Date.now() - 600_000,
    },
  ],
  connectedClientClusters: [
    ...
    },
    {
      ...
      consumerTag: "team-unresponsive",
      clientNames: ["claude-code"],
      sessionIds: ["unresponsive-0001"],
      usage: {
        callCount: 3,
        lastCalledAt: date("2026-05-11T13:00:00.000Z"),
      },
    },
    {
      identityType: "consumerTag",
