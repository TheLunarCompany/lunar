...
const styles = {
  toolCard: "bg-white rounded-lg p-3 border-2 border-gray-200 hover:border-[#4F33CC] hover:shadow-md transition-all duration-200 min-h-[100px] flex flex-col",
  ...
  purpleCheckbox: "bg-[#4F33CC] text-white w-4 h-4 rounded flex items-center justify-center",
  toolCardContent: "flex-1 flex flex-col justify-between",
  toolTitle: "font-medium text-gray-900 text-sm mb-1 truncate",
  toolDescription: "text-gray-600 text-xs text-overflow-ellipsis leading-relaxed",
};
