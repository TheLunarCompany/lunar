...
function CapabilityItemCardRoot({
  ...
  return (
    <Card
      className={cn(
        "relative flex w-[376px] max-w-full flex-col gap-4 rounded-lg border border-[var(--structure-color-border-primary)] bg-[var(--colors-white)] p-4 py-4 text-[var(--text-colours-color-text-primary)] shadow-none ring-0",
        className,
      )}
      {...props}
    >
