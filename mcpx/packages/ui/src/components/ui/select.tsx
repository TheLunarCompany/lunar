...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-hidden  focus:bg-select-primary-hover  data-disabled:pointer-events-none data-disabled:opacity-50",
      className,
    )}
    {...props}
  >
