...
const ConnectionLine = ({ active, direction = 'to-right' }) => {
  ...
  return (
    <svg width="120" height="20" xmlns="http://www.w3.org/2000/svg" className="overflow-visible">
      <defs>
        <marker
          id={arrowId}
          markerWidth="10"
        ...
        >
          <polyline points="0,0 5,3.5 0,7" fill="none" className={active ? "stroke-[var(--color-fg-success)]" : "stroke-[var(--color-text-disabled)]"} strokeWidth="1.5"/>
        </marker>
      </defs>
      <line
        x1={x1}
