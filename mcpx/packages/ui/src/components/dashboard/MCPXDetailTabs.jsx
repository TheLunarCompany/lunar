    ...
    <Card className="shadow-sm border-[var(--color-border-primary)] bg-[var(--color-bg-container)] h-full flex flex-col">
      <CardHeader className="border-b border-[var(--color-border-primary)] py-2 px-3 flex-shrink-0">
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm font-bold text-[var(--color-text-primary)]">MCPX Details</CardTitle>
            ...
            {selectedAgent ? (
              ...
              <div className="h-full flex items-center justify-center p-4">
                <div className="text-center text-[var(--color-text-secondary)]">
                  ...
                  <p className="text-sm">Select an AI Agent from the diagram to configure access controls</p>
                </div>
              </div>
            )}
          </div>
